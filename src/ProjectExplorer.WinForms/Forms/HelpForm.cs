...
public class HelpForm : Form
{
    ...
    private void BuildContent()
    {
        ...
        AppendBullet(
            ...
            "Copy Path, Properties, Edit Description…, Remove from Project (plus Check Availability " +
            "Now / Locate Folder… / Stop-Resume Auto-Retry when unavailable).");
        AppendBullet(
            "File Reference — Open, Open Containing Folder, Copy Path, Properties, Edit…, " +
            "Remove from Project (plus Check Availability Now / Locate File… / Stop-Resume " +
            "Auto-Retry when unavailable).");
        AppendBullet(
            "Web Resource — Open in External Browser, Copy URL, Edit…, Remove from Project (plus " +
            "Check Availability Now / Stop-Resume Auto-Retry when unavailable).");
        AppendParagraph(
